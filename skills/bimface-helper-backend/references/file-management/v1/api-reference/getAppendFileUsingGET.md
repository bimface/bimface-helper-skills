# 获取追加文件信息
```
GET https://api.bimface.com/bdfs/data/v1/projects/{projectId}/fileItems/appendFile
```
...
##### 请求 path
```
https://api.bimface.com/bdfs/data/v1/projects/10000000006016/fileItems/appendFile?appendFileId=1938888813662976
```
