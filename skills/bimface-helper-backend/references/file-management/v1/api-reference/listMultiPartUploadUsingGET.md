...
```
GET https://api.bimface.com/bdfs/v1/data/projects/{project-id}/file-items/multi-part-files/upload-parts
```
...
##### 请求 path
```
https://api.bimface.com/bdfs/v1/data/projects/string/file-items/multi-part-files/upload-parts?id=1938888813662976
```
