...
|HTTP代码|说明|类型|
|---|---|---|
|**200**|OK|GeneralResponse«RfaFamilyTypeProperty»|
|**401**|Unauthorized|-|
|**403**|Forbidden|-|
|**404**|Not Found|-|
...
|---|---|---|
|code|状态代码|string|
|data|返回数据|RfaFamilyTypeProperty|
|familyTypeId|族类型ID|string|
|name|族类型名称|string|
...
##### 请求 path
```
https://api.bimface.com/data/v2/rfaFiles/1938888813662976/familyTypes/f1a75aa9-d417-46a1-806d-bc4058583821
```
