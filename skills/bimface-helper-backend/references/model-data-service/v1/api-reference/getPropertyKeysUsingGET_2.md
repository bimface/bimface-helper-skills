# 获取模型所有属性字段
```
GET https://api.bimface.com/data/v2/integrations/{integrateId}/propertyKeys
```
...
##### 请求 path
```
https://api.bimface.com/data/v2/integrations/1938888813662976/propertyKeys?includeOverrides=false
```
